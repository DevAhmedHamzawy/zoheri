...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h4 class="text-center">إضافة خصم جديد</h4></div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('discounts.store') }}">
                        ...
                        <div class="input-group row mb-3" id="discount_amount">
                            ...
                            <input id="amount" type="number" min="0" class="form-control @error('amount') is-invalid @enderror ml-4" name="amount" value="{{ old('amount') }}" required autocomplete="amount">
