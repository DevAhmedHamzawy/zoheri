...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h4 class="text-center">إضافة حاجز جديد</h4></div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('hurdles.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="slogan" type="text" pattern="^[\x20-\x7F]+$" class="form-control @error('slogan') is-invalid @enderror" name="slogan" value="{{ old('slogan') }}" required autocomplete="slogan"   >
