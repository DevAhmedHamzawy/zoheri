            ...
            <div class="wrap-login100 pt-3 p-b-30">
                <form method="POST" action="{{ route('login') }}"  class="login100-form validate-form">
                    ...
                    <div class="login100-form-avatar">
                        <img src="{{ asset('panel/panel/img/logo.png') }}" alt="AVATAR">
                    </div>
                    ...
                    <div class="form-group form-check" style="padding-left: 85%;">
                        <input type="checkbox" class="form-check-input" {{ old('remember') ? 'checked' : '' }} id="exampleCheck1">
                        <label class="form-check-label small text-white pr-3" for="exampleCheck1">تذكرنى</label>
                    </div>
                    ...
                    <div class="container-login100-form-btn p-t-10">
                        <a href="{{ route('forget_password') }}" class="login100-form-btn">
                            نسيت كلمة المرور
                        </a>
                    </div>
